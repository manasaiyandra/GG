...
const DialogueItem: React.FC<{
    ...
    <div
        ...
        className={`dialogue-item p-4 rounded-lg border-2 border-slate-600 bg-slate-800 mb-2 transition-all duration-300 ${isDraggable ? 'cursor-grab hover:bg-slate-700' : 'cursor-not-allowed opacity-70'}`}
    >
    ...
    if (isComplete) {
         return (
             <div className="text-center">
                 ...
                 <p className="text-5xl font-bold mb-8">{score} <span className="text-2xl text-slate-400">points</span></p>
